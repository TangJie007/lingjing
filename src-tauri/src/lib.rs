...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            online_cache::begin_online_file_write,
            online_cache::append_online_file_write,
            online_cache::finish_online_file_write,
            online_cache::abort_online_file_write,
            ...
            desktop_organize::drag::arm_desktop_outgoing_drag_watch,
            desktop_organize::drag::cancel_desktop_outgoing_drag_watch,
